...
try {
    ...
    $role = isset($_POST['role']) ? trim($_POST['role']) : 'Patient';
    ...
    $sqlPatient = "INSERT INTO patients (accounts_id, firstname, lastname, address, medical_history, birthday, gender) 
                   VALUES (:accounts_id, :firstname, :lastname, NULL, NULL, NULL, NULL)";
